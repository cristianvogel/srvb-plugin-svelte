import { Default } from '$lib/components/PrecisUI/Precis-UI-Defaults';
import type { TickMark, PointsArray } from '$lib/precisUI/Precis-UI-TypeDeclarations';
...
export function radialPoints(angleDegrees, cx, cy, rMin, rMax, nPoints): PointsArray {
...
export function radialTickMarkAt(
	i: number,
	steps: number = 11,
	offsetDegrees: number = Default.DIAL_TICKMARKS_RADIAL_OFFSET
): TickMark {
